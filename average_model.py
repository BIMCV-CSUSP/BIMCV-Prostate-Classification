...
if __name__ == "__main__":
    fold_paths = [
        "/home/ceib/jaalzate/BIMCV-Prostate-Classification/logs/classification/Prostate_Picai_efficientnetb7/18-Aug-2025-10:41:51/models/Fold 0/best-model-weights.pth",
        "/home/ceib/jaalzate/BIMCV-Prostate-Classification/logs/classification/Prostate_Picai_efficientnetb7/18-Aug-2025-10:41:51/models/Fold 1/best-model-weights.pth",
        "/home/ceib/jaalzate/BIMCV-Prostate-Classification/logs/classification/Prostate_Picai_efficientnetb7/18-Aug-2025-10:41:51/models/Fold 2/best-model-weights.pth",
        "/home/ceib/jaalzate/BIMCV-Prostate-Classification/logs/classification/Prostate_Picai_efficientnetb7/18-Aug-2025-10:41:51/models/Fold 3/best-model-weights.pth",
        "/home/ceib/jaalzate/BIMCV-Prostate-Classification/logs/classification/Prostate_Picai_efficientnetb7/18-Aug-2025-10:41:51/models/Fold 4/best-model-weights.pth",
    ]
    fold_f1 = [0.2224, 0.2756, 0.2264, 0.2307, 0.0448]

    model = build_new_model_from_folds(
        fold_ckpt_paths=fold_paths,
        fold_validation_scores=fold_f1,
        new_num_classes=2,
        model_name="efficientnet-b7",
        in_channels=3
    )
    torch.save(model.state_dict(), "averaged_pretrained_backbone.pt")